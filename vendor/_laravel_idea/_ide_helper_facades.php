<?php //65ed9966fd376bdf973d4cf996b645fc
/** @noinspection all */
...
namespace anlutro\LaravelSettings {
    ...
    /**
     * @see SettingsManager::createDatabaseDriver
     * @method static void createDatabaseDriver()
     * @see \Illuminate\Support\Manager::forgetDrivers
     * @method static \Illuminate\Support\Manager forgetDrivers()
     * @see SettingsManager::createArrayDriver
     * @method static void createArrayDriver()
     * @see \Illuminate\Support\Manager::setContainer
     * @method static \Illuminate\Support\Manager setContainer(\Illuminate\Contracts\Container\Container $container)
     * @see \Illuminate\Support\Manager::extend
     * @method static \Illuminate\Support\Manager extend(string $driver, \Closure $callback)
     * @see \Illuminate\Support\Manager::driver
     * @method static mixed driver(null|string $driver = null)
     * @see SettingsManager::createMemoryDriver
     * @method static void createMemoryDriver()
     * @see \Illuminate\Support\Manager::getContainer
     * @method static \Illuminate\Contracts\Container\Container getContainer()
     * @see SettingsManager::createJsonDriver
     * @method static void createJsonDriver()
     * @see SettingsManager::getDefaultDriver
     * @method static string getDefaultDriver()
     * @see \Illuminate\Support\Manager::getDrivers
     * @method static array getDrivers()
     */
...
namespace anlutro\LaravelSettings\Facades {
    ...
    /**
     * @see \anlutro\LaravelSettings\SettingsManager::createDatabaseDriver
     * @method static void createDatabaseDriver()
     * @see \Illuminate\Support\Manager::forgetDrivers
     * @method static \Illuminate\Support\Manager forgetDrivers()
     * @see \anlutro\LaravelSettings\SettingsManager::createArrayDriver
     * @method static void createArrayDriver()
     * @see \Illuminate\Support\Manager::setContainer
     * @method static \Illuminate\Support\Manager setContainer(\Illuminate\Contracts\Container\Container $container)
     * @see \Illuminate\Support\Manager::extend
     ...
     * @see \Illuminate\Support\Manager::driver
     * @method static mixed driver(null|string $driver = null)
     * @see \anlutro\LaravelSettings\SettingsManager::createMemoryDriver
     * @method static void createMemoryDriver()
     * @see \Illuminate\Support\Manager::getContainer
     * @method static \Illuminate\Contracts\Container\Container getContainer()
     * @see \anlutro\LaravelSettings\SettingsManager::createJsonDriver
     * @method static void createJsonDriver()
     * @see \anlutro\LaravelSettings\SettingsManager::getDefaultDriver
     * @method static string getDefaultDriver()
     * @see \Illuminate\Support\Manager::getDrivers
     * @method static array getDrivers()
     */
