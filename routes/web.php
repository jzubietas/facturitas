...
Route::middleware(['auth:sanctum', 'verified', 'auth.redirect.is_disabled'])->group(function () {
    ...
    Route::any('dashboard.publicidad.calendario.add', [DashboardController::class, 'addPublicidadCalendario'])->name('dashboard.publicidad.calendario.add');
...
//Route::get('recurrentestabla', [ClienteController::class, 'tablarecurrentes'])->name('recurrentestabla');
    ...
    Route::post('cliente.revertir.congelado', [ClienteController::class, 'clienteRevertirCongelado'])->name('cliente.revertir.congelado');
    ...
    Route::post('basefria.store.publicidad', [BasefriaController::class, 'storePublicidad'])->name('basefria.store.publicidad');
...
//Route::get('pedidos.destroyid', [PedidoController::class, 'destroyid'])->name('pedidos.destroyid');
    ...
    Route::post('operaciones.veratencionidunico', [OperacionController::class, 'verAtencionIdUnico'])->name('operaciones.veratencionidunico');
...
/////////
    ...
    Route::get('administracion.revisar.pedidosapagar', [AdministracionController::class, 'RevisarPedidosAPagar'])->name('administracion.revisar.pedidosapagar');
    //agregado para serverside
    ...
    Route::any('reportes.analisis.rendimiento', [PdfController::class, 'AnalisisRendimiento'])->name('reportes.analisis.rendimiento');
