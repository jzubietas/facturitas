...
@section('content_header')
  <h1>Operarios - Área de operaciones
    {{-- @can('users.create')
      ...
      <table id="tablaPrincipal" class="table table-striped">
        <thead>
          <tr>
            ...
            <th scope="col">JEFE DE OPERACIONES</th>
            ...
            <tr>
              ...
              <td>
                {{-- @can('users.asignarjefe') --}}
                  ...
                  <a href="" data-target="#modal-asignarjefe-{{ $user->id }}" data-toggle="modal"><button class="btn btn-info btn-sm">Asignar jefe de operaciones</button></a>
                {{-- @endcan --}}
              </td>
            </tr>
            @include('usuarios.modal.asignarjefe')
          @endforeach
        </tbody>
      </table>
    </div>
