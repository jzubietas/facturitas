  <!-- Modal -->
  <div class="modal fade" id="modal-correccion-op" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 800px!important;">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h5 class="modal-title" id="exampleModalLabel">Coregir pedido</h5>
        </div>
        {{-- Form::Open(['route' => ['pedidos.atender', $pedido],'enctype'=>'multipart/form-data', 'id'=>'formulario','files'=>true]) --}}
        <form id="formulariocorreccionatender" name="formulariocorreccionatender" enctype="multipart/form-data">
          <input type="hidden" id="correccion" name="correccion">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-info" id="corregir-atencion">Corregir</button>
        </div>
        {{ Form::Close() }}
      </div>
    </div>
