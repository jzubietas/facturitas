...
<table>
    @foreach($imagenes as $img)
        <tr class="adjuntos_sinconfirmar" data-adjunto="{{ $img->adjunto }}">
            <td>
...
<input type="hidden" id="adjunto_total_attachment" value="{{count($imagenes_confirm)}}">
<table>
    @foreach($imagenes_confirm as $img)
