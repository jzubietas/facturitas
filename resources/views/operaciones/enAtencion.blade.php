...
@section('content_header')
    <h1>Lista de pedidos en atencion - OPERACIONES
...
@section('content')
    ...
    <div class="card" style="overflow: hidden !important">
        <div class="card-body" style="overflow-x: scroll !important">
            <br>
            <table id="tablaOperacionesPedidosEnAtencion" class="table table-striped">
                <thead>
                <tr>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on("click", "#cerrarmodalatender", function (evento) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#tablaOperacionesPedidosEnAtencion').DataTable().ajax.reload();
                    }
                });
            });
            ...
            $('#tablaOperacionesPedidosEnAtencion').DataTable({
                processing: true,
                //stateSave:true,
                serverSide: true,
                searching: true,
    ...
    <script>
        /*window.onload = function () {
          $('#tablaOperacionesPedidosEnAtencion').DataTable().draw();
        }*/
    </script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#tablaOperacionesPedidosEnAtencion').DataTable();
