...
/*
              ...
              if(row.condicion_envio_code==5)
              {
                ...
                data = data+'<a href="#" data-target="#" class="btn-sm dropdown-item text-gray" data-envio='+row.id+' data-code="'+ row.codigos +'" data-toggle="" disabled><i class="fa fa-envelope text-gray" aria-hidden="true"></i> ENVIO A COURIER JEFE OPE</a>';
