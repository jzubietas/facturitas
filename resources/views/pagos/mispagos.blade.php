            ...
            $('#tablaPrincipal').DataTable({
                ...
                columns: [
                    ...
                    render: function (data, type, row, meta) {
                            ...
                            if (row.id < 10) {
                                return row.code+'------'+'PAG' + row.users + unido + '000' + row.id;
                            } else if (row.id < 100) {
                                return row.code+'------'+'PAG00' + row.users + unido + '' + row.id;
                            } else if (row.id < 1000) {
                                return row.code+'------'+'PAG0' + row.users + unido + '' + row.id;
                            } else {
                                return row.code+'------'+'PAG' + row.users + unido + '' + row.id;
                            }
