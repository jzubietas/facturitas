  <!-- Modal -->
  <div class="modal fade" id="modal-add-pedidos-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="form-row">
            <div class="form-group col-lg-12">
              ...
              <select name="ppedido_id" id="ppedido_id" class="border form-control border-secondary">
                ...
                <option value="{{$pedido->id}}_{{$pedido->codigo}}_{{$pedido->total}}'">Código: {{$pedido->codigo}} - Total: S/{{ $pedido->total}}</option>
                @endforeach
              </select>
            </div>
          </div>
