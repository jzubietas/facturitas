        ...
        <div class="border rounded card-body border-secondary" style="margin: 1%">
            <div class="form-row">
                <div class="form-group col-lg-6">
                    ...
                    {{--<input type="hidden" name="user_id" requerid value="{{ Auth::user()->id }}"
                               class="form-control">--}}
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::label('cliente_id', 'Cliente*') !!}{!! Form::hidden('cliente_id', '',['id' =>
                    'cliente_id']) !!}
                    ...
                    <select name="pcliente_id" class="border form-control selectpicker border-secondary"
                        ...
                        <option value="{{ $cliente->id }}_{{ $cliente->saldo }}">{{$cliente->nombre}} -
                            {{$cliente->celular}}
                        </option>
                        @endforeach
                        --}}
            ...
            <div class="form-row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <div class="table-responsive">
                        <table id="tabla_pagos" class="table table-striped">
                            ...
                            <th><input type="text" name="total_pago_pagar" requerid value="" id="total_pago_pagar"
                ...
                <div class="form-group col-lg-6">
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-6">
                            {{-- <a data-target="#modal-add-pedidos" id="addpedido" data-toggle="modal">
        ...
        <div class="card-footer">
            <div class="form-row">
                ...
                <div class="form-group col-lg-1">
                    <div id="guardar">
                        <button id="registrar_pagos" type="submit" class="btn btn-success"><i class="fas fa-save"></i>
                            Guardar
                        </button>
                    </div>
                </div>
