  ...
  <table id="tabla" class="table ">
    @foreach ($pedidos as $pedido)
        ...
        <tr style="border-bottom: 1px dashed #888; padding-bottom:8px; ">
          <th colspan="2">
            ...
            <th>
                ...
                <p style="font-size:12px; color:#888;">Escanee el QR para recibir esta correccion</p>
            </th>
        </tr>
      <tr>
          <td colspan="3">
      ...
      <tbody>
        ...
        @else
          <tr>
            <th colspan="2" style="background: white">SUSTENTO</th>
          </tr>
          <tr>
            <td colspan="2"><p style="font-size: 14px;">{{ $pedido->descripcion }}</div></p></td>
          </tr>
