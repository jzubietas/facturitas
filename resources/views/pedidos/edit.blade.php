          ...
          <div class="card-body">
            <div class="form-row">
              <div class="form-group col-lg-6">
                ...
                @foreach ($pedidos as $pedido)
                <input type="text" name="user_name" value="{{ $pedido->users }}" class="form-control" disabled>
              </div>
              <div class="form-group col-lg-6">
          ...
          <div class="card-body">
            <div class="form-row">
              @foreach ($pedidos as $pedido)
                ...
                <div class="form-group col-lg-2">
                  {!! Form::label('pruc', 'RUC') !!}
                      <input type="number" name="pruc" id="pruc" value="{{ $pedido->ruc}}" step="1" min="0" max="99999999999" maxlength="11" oninput="maxLengthCheck(this)" class="form-control" placeholder="RUC...">
                </div>
                <div class="form-group col-lg-2">
                ...
                <div class="form-group col-lg-3">
                  ...
                  <select name="ptipo_banca" class="border form-control selectpicker border-secondary" id="ptipo_banca" data-live-search="true">
                    <option value="">---- SELECCIONE ----</option>
                      @foreach($porcentajes as $porcentaje)
                    <option value="{{ $porcentaje->nombre }}_{{ $porcentaje->porcentaje }}" {{ ($porcentaje->nombre == $pedido->tipo_banca ? "selected" : "") }}>{{$porcentaje->nombre}}</option>
                      @endforeach
                  </select>
                </div>
                <div class="form-group col-lg-2">
                ...
                <div class="form-group col-lg-3">
                  {!! Form::label('pcourier', 'Courier(S/)') !!}
                    ...
                    <input type="text" name="pcourier" id="pcourier" value="{{ $pedido->courier}}" step="0.01" min="0" class="form-control number" placeholder="Courier...">
                </div>
                <div class="form-group col-lg-4">
                  {!! Form::label('pdescripcion', 'Descripción') !!}
                    <input type="text" name="pdescripcion" id="pdescripcion" value="{{ $pedido->descripcion}}" class="form-control" placeholder="Descripción...">
                </div>
                <div class="form-group col-lg-4">
                  {!! Form::label('pnota', 'Nota') !!}
                    <input type="text" name="pnota" id="pnota" value="{{ $pedido->nota}}" class="form-control" placeholder="Nota...">
                </div>
                <div class="form-group col-lg-2">
