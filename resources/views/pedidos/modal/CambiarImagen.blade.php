    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title" id="exampleModalLabel">Cambiar Imagen 1</h5>
        ...
        <input type="text" value="" name="cambiapedido" id="cambiapedido">
        <input type="text" value="" name="cambiaitem" id="cambiaitem">
