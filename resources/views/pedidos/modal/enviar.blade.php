  <!-- Modal -->
  <div class="modal fade" id="modal-enviar-{{ $pedido->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 900px!important;">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Complete los siguientes datos del envío del pedido: <strong>PED00{{ $pedido->id }}</strong></p>
        </div>
