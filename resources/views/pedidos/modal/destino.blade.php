<!-- Modal -->
<div class="modal fade" id="modal-destino-{{ $pedido->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Elija el destino de envío del pedido: <strong>PED000{{ $pedido->id }}</strong></p>
      </div>
