      ...
      <div class="modal-body">
        {{-- <div class="form-row"> --}}
          <div class="form-group col-lg-12">
            <p style="text-align: justify;">Confirme si desea <strong>ANULAR</strong> el pedido: <strong class="textcode">PED000</strong></p>
          </div>
          <div class="form-group col lg-12">
          ...
          <div class="form-group col lg-12">
            ...
            {!! Form::text('responsable', '', ['class' => 'form-control', 'placeholder' => 'Responsable', 'required' => 'required']) !!}
          </div>
        {{-- </div> --}}
      </div>
