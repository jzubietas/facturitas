    ...
    <div class="modal-dialog" style="max-width: 800px!important;">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title" id="exampleModalLabel">Bloquear cliente base fria</h5>
            ...
            <form id="formdelete" name="formdelete">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-lg-12">
                        <p style="text-align: justify;">Confirme si desea <strong>BLOQUEAR</strong> el cliente de base fria: <strong
