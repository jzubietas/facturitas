  ...
  <script>
    $(document).ready(function () {
      ...
      $('#modal-direccion').on('show.bs.modal', function (event) {
        ...
        $('#tablaPrincipalpedidosagregar').DataTable().clear().destroy();
      ...
      $('#tablaPrincipal').DataTable({
        ...
        columns: [
          ...
          },
          {
            ...
            render: function ( data, type, row, meta ) {   
              datass='';
              datass=datass+'<a href="" data-target="#modal-direccion" data-toggle="modal" data-direccion="'+row.id+'"><button class="btn btn-info btn-sm"><i class="fas fa-envelope"></i> Direccion</button></a>';  
