<table>
  <thead>
    <tr>
      ...
      <th style="background-color: #67c97c; text-align: center; color: #ffff;">ID ASESOR</th>
      <th style="background-color: #67c97c; text-align: center; color: #ffff;">IDENTIFICADOR ASESOR</th>
