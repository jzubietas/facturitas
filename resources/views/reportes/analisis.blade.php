            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <canvas id="my-chart-activosbloqueados_barra"  style="min-height: 750px; height: 750px; max-height: 750px; max-width: 100%;"></canvas>
                            </div>
                        </div>
                    </div>
...
@section('js-datatables')
    ...
    <script>
        ...
        function grafico_activos_bloqueados_barra()
        {
            $.ajax({
                method:'GET',
                dataType: "json",
                url:"{{ route('chart-clientes-activos-bloqueados') }}",
                success:function(data){
                    //console.log(data)
                    var data_activosbloqueadosbarra ={
                        labels:data.labels,
                        datasets:data.datasets,
                    };

                    var options_activosbloqueadosbarra = {
                        /*annotation:{
                          annotations:[{
                              type:'line',
                              mode:'horizontal',
                    ...
                    var ctx_activosbloqueadosbarra = document.getElementById("my-chart-activosbloqueados_barra").getContext('2d');
                    var myChart_vienendebarra = new Chart(ctx_activosbloqueadosbarra, {
                        type: 'bar',
                        data: data_activosbloqueadosbarra,
                        options: options_activosbloqueadosbarra
                    });
                }
            });
        }
