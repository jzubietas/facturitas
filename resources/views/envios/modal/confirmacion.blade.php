        ...
        {{-- Form::Open(['route' => ['pedidos.atender', $pedido],'enctype'=>'multipart/form-data', 'id'=>'formulario','files'=>true]) --}}
          <form id="formulario_confirmacion" name="formulariorecepcion" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col">
                    <p>Esta seguro que desea enviar el sobre <strong class="textcode"></strong> a Motorizados del <strong class="textzone"></strong></p>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    {!! Form::date('fecha_salida', null, ['class' => 'form-control', 'id' => 'fecha_salida']) !!}
                  </div>
                </div>
