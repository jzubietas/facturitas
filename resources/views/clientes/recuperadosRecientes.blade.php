...
@section('title', 'Lista de Clientes RECIENTES')
...
@section('content_header')
    <h1>Lista de clientes en situacion RECUPERADOS ABANDONO RECIENTES
        @can('clientes.create')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#tablaPrincipal').DataTable({
                ...
                autowidth: true,
                serverSide: true,
                ajax: "{{ route('recuperadostabla',['situacion'=>\App\Models\Cliente::RECUPERADO_RECIENTE]) }}",
                ...
                columns: [
                    ...
                    {data: 'codigoultimopedido', name: 'codigoultimopedido'},
                    {
                        ...
                        sWidth: '20%',
                        render: function (data, type, row, meta) {
                            var urledit = '{{ route("clientes.edit.recuperado.reciente", ":id") }}';
                            urledit = urledit.replace(':id', row.id);

                            var urlshow = '{{ route("clientes.show", ":id") }}';
                            urlshow = urlshow.replace(':id', row.id);

                            @can('clientes.edit.recuperado.reciente')
