...
class PageclienteinfoFebrero2023 extends Export implements WithColumnFormatting,WithColumnWidths
{
    public function collection()
    {
        $cliente = Cliente::with('user')
            ...
            ->select(
                ...
                ,'clientes.icelular'
                ,'clientes.celular'
                ,DB::raw(" (select a.situacion from situacion_clientes a where a.cliente_id=clientes.id and a.periodo='2023-02') as situacion ")
