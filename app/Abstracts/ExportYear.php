...
abstract class ExportYear implements FromCollection, HasLocalePreference, ShouldAutoSize, ShouldQueue, WithHeadings, WithMapping, WithTitle
{
    use Exportable;
    ...
    public function __construct($ids = null,$anio=null)
    {
        $this->ids = $ids;
        $this->anio = $anio;
        $fields = $this->fields();
