    ...
    public function datatable(Request $request)
    {
        $query = GrupoPedido::query()->with([
            ...
            ->select([
              ...
              DB::raw('( select p.condicion_envio_code from grupo_pedidos gp inner join grupo_pedido_items gpi on gp.id =gpi.grupo_pedido_id inner join pedidos p on p.id =gpi.pedido_id where  gp.id =grupo_pedidos.id) as condicion_envio_code'),
