                    ...
                    if (0<=$data["progress_pedidos"] && $data["progress_pedidos"] < 37)
                    {
                        ...
                        $html .= '<div class="w-100 bg-white rounded">
                                              <div class="position-relative rounded">
                                                  ...
                                                  <div class="position-absolute rounded w-100 text-center" style="top: 5px;font-size: 12px;">
                                                      <span style="font-weight: lighter"> <b class="bold-size" style="font-weight: bold !important;font-size: 18px;color:blue;">  ' . $data["progress_pedidos"] . '% </b> - ' . $data["total_pedido"] . ' /' . $data["meta_intermedia"] . '  <p class="text-red d-inline format-size" style="font-size: 18px; color: #d9686!important"> ' . ((($data["meta_intermedia"] - $data["total_pedido"]) > 0) ? ($data["meta_intermedia"] - $data["total_pedido"]) : '0') . '</p></span>
                                                  </div>
                                              </div>
                                            </div>
                                            '.$sub_html;
                    ...
                    if (  0<=$data["progress_pedidos"] && $data["progress_pedidos"] < 34)
                    {
                        $html .= '<div class="w-100 bg-white rounded">
                              <div class="position-relative rounded">
                                  ...
                                  <div class="position-absolute rounded w-100 text-center" style="top: 5px;font-size: 12px;">
                                      <span style="font-weight: lighter"> <b class="bold-size" style="font-weight: bold !important;font-size: 18px;color:blue;">  ' . $data["progress_pedidos"] . '% </b> - ' . $data["total_pedido"] . ' /' . $data["meta"] . '  <p class="text-red d-inline format-size" style="font-size: 18px; color: #d9686!important"> ' . $diferencia_mostrar . '</p></span>
                                  </div>
                              </div>
                            </div>
                            '.$sub_html;
                        ...
                        $html .= '<div class="w-100 bg-white rounded">
                                    <div class="position-relative rounded">
                                      <div class="progress bg-white rounded height-bar-progress" style="height: 25px !important">
                                        ...
                                        <div class="position-absolute rounded w-100 text-center" style="top: 5px;font-size: 12px;">
                                            <span style="font-weight: lighter"> <b class="bold-size" style="font-weight: bold !important;font-size: 18px;color:blue;">  ' . $data["progress_pedidos"] . '% </b> - ' . $data["total_pedido"] . ' / ' . $data["meta_2"] . '<p class="text-red d-inline format-size" style="font-size: 18px; color: #d9686!important"> ' . $diferencia_mostrar . '</p></span>
                                        </div>
                                    </div>
                                  </div>
                                  '.$sub_html;
