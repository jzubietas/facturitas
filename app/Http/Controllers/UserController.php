...
class UserController extends Controller
{
    ...
    public function Asesorcombo(Request $request)
    {
        ...
        if ($mirol == 'Llamadas') {
            ...
            $users = User::where('estado', '1')->where("rol", "Asesor")->whereIn('clave_pedidos',['15','16','17','18','19','20','21','22','23']);
        }
        else {
    ...
    public function AsesorcomboModal(Request $request)
    {
        ...
        if ($mirol == 'Llamadas') {
            ...
            $users = User::where('estado', '1')->where("rol", "Asesor")->whereIn('identificador',['15','16','17','18','19','20','21','22','23']);
        }
        else {
    ...
    {
        $respuesta=[];
        $p_fsb = Porcentaje::where('cliente_id', '=', $request->cliente_id)
            ->where('nombre','=','FISICO - sin banca')->first();
        $respuesta[]=['FSB'=> ( ($p_fsb===null)? 0:$p_fsb->porcentaje ) ];
