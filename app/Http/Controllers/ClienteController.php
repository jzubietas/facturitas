...
class ClienteController extends Controller
{
    ...
    public function indexpretendido()
    {
        $dateM = Carbon::now()->format('m');
        $dateY = Carbon::now()->format('Y');
        $mirol = Auth::user()->rol;
        ...
        return view('clientes.pretendidos', compact('anios', 'dateM', 'dateY', 'superasesor', 'mirol'));
    }

    public function indexbloqueado()
    {
        $dateM = Carbon::now()->format('m');
        $dateY = Carbon::now()->format('Y');
        $mirol = Auth::user()->rol;
        ...
        return view('clientes.bloqueados', compact('anios', 'dateM', 'dateY', 'superasesor', 'mirol'));
    }

    public function indexcongelado()
    {
        $dateM = Carbon::now()->format('m');
        $dateY = Carbon::now()->format('Y');
        $mirol = Auth::user()->rol;
        ...
        return view('clientes.congelados', compact('anios', 'dateM', 'dateY', 'superasesor', 'mirol'));
    }
    ...
    public function indexpretendidotabla(Request $request)
    {
        ...
        join('users as u', 'clientes.user_id', 'u.id')
            ...
            ->where('clientes.situacion',Cliente::PRETENDIDO)
            ->groupBy(
                'clientes.id',
                'clientes.nombre',
                'clientes.icelular',
    ...
    public function indexbloqueadotabla(Request $request)
    {
    ...
    public function indexcongeladotabla(Request $request)
    {
    ...
    public function indexrecuperadotabla(Request $request)
    {
        ...
        join('users as u', 'clientes.user_id', 'u.id')
            ->leftjoin('pedidos as p', 'clientes.id', 'p.cliente_id')
            ->where('clientes.estado', '1')
            ->whereNotIn('clientes.user_clavepedido',['B','17','18','19','99','B'])
            ->where('clientes.tipo', '1')
            ->when($request->has("situacion"), function ($query) use ($request) {
