...
*/
    ...
    public function Terminadostabla(Request $request)
    {
        ...
        $pedidos = Pedido::join('users as u', 'pedidos.user_id', 'u.id')
            ...
            ->whereIn('pedidos.condicion_envio_code', [Pedido::CONFIRMACION_COURIER_INT, Pedido::SOBRE_ENVIAR_INT,Pedido::REPARTO_COURIER_INT,Pedido::SEGUIMIENTO_PROVINCIA_COURIER_INT, Pedido::ENTREGADO_CLIENTE_INT, Pedido::CONFIRMACION_COURIER_INT,Pedido::RECEPCION_COURIER_INT,Pedido::ENTREGADO_SIN_SOBRE_OPE_INT, Pedido::ENTREGADO_SIN_SOBRE_CLIENTE_INT]);
