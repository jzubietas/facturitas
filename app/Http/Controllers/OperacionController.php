...
*/
    ...
    public function Terminadostabla(Request $request)
    {
        ...
        $pedidos = Pedido::join('users as u', 'pedidos.user_id', 'u.id')
            ...
            ->where('dp.estado', '1')
            ->where('pedidos.condicion_code', Pedido::ATENDIDO_INT)
            ->whereIn('pedidos.condicion_envio_code', [Pedido::COURIER_INT, Pedido::SOBRE_ENVIAR_INT,Pedido::EN_REPARTO_INT,Pedido::SEG_PROVINCIA_INT, Pedido::ENTREGADO_INT, Pedido::JEFE_OP_CONF_INT,Pedido::ENTREGADO_SIN_SOBRE_INT])
