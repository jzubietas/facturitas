...
class PdfController extends Controller
{
    ...
    public function Analisisgrafico()
    {
      ...
      foreach ($_pedidos_mes_pasado as $pedido)
      {
        ...
        $html[]= '<div class="p-3 text-center d-flex align-items-center justify-content-center" style="border: black 1px solid; background: #e4dbc6"><h5 class="rounded p-4 font-weight-bold" style=" background: '.Pedido::color_skype_blue.'; color: rgba(94,94,94,0.89);">' .$pedido->recuperado_reciente.'</h5></div>';
        ...
        $html[]='<div class="p-3 text-center d-flex align-items-center justify-content-center" style="border: black 1px solid; background: #e4dbc6"><h5 class="rounded p-4 font-weight-bold" style="background: '.Pedido::color_blue.'; color: #ffffff;">'.$p_total.'</h5></div>';
      ...
      $html[]='<div class="p-3 text-center d-flex align-items-center justify-content-center" style="border: black 1px solid; background: #e4dbc6"><h5 class="rounded p-4 font-weight-bold" style="background: '.Pedido::color_blue.'; color: #ffffff;">'.$p_recuperado_reciente.'</h5></div>';
      ...
      $html[]='<div class="p-3 text-center d-flex align-items-center justify-content-center" style="border: black 1px solid; background: #e4dbc6"><h5 class="rounded p-4 font-weight-bold" style="background: '.Pedido::color_blue.';color: #ffffff;">'.$p_recuperado_abandono.'</h5></div>';
      ...
      $html[]='<div class="p-3 text-center d-flex align-items-center justify-content-center" style="border: black 1px solid; background: #e4dbc6"><h5 class="rounded p-4 font-weight-bold" style="background: '.Pedido::color_blue.'; color: #ffffff;">'.$p_recuperado_nuevo.'</h5></div>';
      $html[]='<div class="p-3 text-center d-flex align-items-center justify-content-center" style="border: black 1px solid; background: #e4dbc6"><h5 class="rounded p-4 font-weight-bold" style="background: '.Pedido::color_blue.'; color: #ffffff;">TOTALES</h5></div>';
