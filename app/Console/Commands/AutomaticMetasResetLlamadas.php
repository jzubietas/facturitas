...
class AutomaticMetasResetLlamadas extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'automatic:metas:reset:llamadas';
    ...
    public function handle()
    {
      ...
      $usuarios=User::whereIn('rol',[User::ROL_LLAMADAS])->orderBy('id','asc')->get();
