...
class Pedido extends Model
{
    ...
    const CONFIRMAR_RECOJO_MOTORIZADO = 'CONFIRMAR RECIBIDO  RECOJO - MOTORIZADO'; //32
    const ENTREGADO_RECOJO_JEFE_OPE_INT = 33;
    const ENVIO_RECOJO_OPE = 'ENVIO RECOJO - OPE'; //33
    const ENTREGADO_RECOJO_JEFE_OPE = 'ENTREGADO RECOJO - OPE'; //34
