...
class Pedido extends Model
{
    ...
    const RECOJO_MOTORIZADO = 'RECOJO - MOTORIZADO'; //27
    const CONFIRMAR_RECOJO_MOTORIZADO = 'CONFIRMAR RECOJO - MOTORIZADO'; //28
    const ENVIO_RECOJO_OPE = 'ENVIO RECOJO - OPE'; //29
    const ENTREGADO_RECOJO_JEFE_OPE = 'ENTREGADO RECOJO - OPE'; //30
...
cosnt RECOJO CLIENTE CONFIRMAR MOTORIZADO*/
    ...
    const RECOJO_MOTORIZADO_INT = 27;
    const CONFIRMAR_CLIENTE_MOTORIZADO_INT = 28;
    const ENVIO_RECOJO_OPE_INT = 29;
    const ENTREGADO_RECOJO_JEFE_OPE_INT = 30;
