...
class Pedido extends Model
{
    ...
    const RECOJO_MOTORIZADO = 'RECOJO - MOTORIZADO'; //28
    const CONFIRMAR_RECOJO_MOTORIZADO = 'CONFIRMAR RECOJO - MOTORIZADO'; //29
    const ENVIO_RECOJO_OPE = 'ENVIO RECOJO - OPE'; //30
    const ENTREGADO_RECOJO_JEFE_OPE = 'ENTREGADO RECOJO - OPE'; //31
...
cosnt RECOJO CLIENTE CONFIRMAR MOTORIZADO*/
    ...
    const REPARTO_RECOJO_COURIER_INT = 'REPARTO RECOJO - COURIER';//27
    const RECOJO_MOTORIZADO_INT = 'RECOJO - MOTORIZADO'; //28
    const CONFIRMAR_RECOJO_MOTORIZADO_INT = 'CONFIRMAR RECOJO - MOTORIZADO'; //29
    const ENVIO_RECOJO_OPE_INT = 'ENVIO RECOJO - OPE'; //30
    const ENTREGADO_RECOJO_JEFE_OPE_INT = 'ENTREGADO RECOJO - OPE'; //31
