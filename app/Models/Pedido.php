...
class Pedido extends Model
{
    ...
    const CONFIRMAR_RECOJO_MOTORIZADO = 'CONFIRMAR RECOJO - MOTORIZADO'; //31
    const ENVIO_RECOJO_OPE = 'ENVIO RECOJO - OPE'; //32
    const ENTREGADO_RECOJO_JEFE_OPE = 'ENTREGADO RECOJO - OPE'; //33
